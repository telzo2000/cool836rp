...
kbd.init_pins(
  ...
  [ 1, 2, 3, 4, 5, 6, 14, 15, 26, 27, 13, 12 ]    # col0, col1,... respectively
)
#keyboard.row_pins = (board.GP9, board.GP10, board.GP11)
#keyboard.col_pins = (board.GP1, board.GP2, board.GP3, board.GP4, board.GP5, board.GP6, board.GP14, board.GP15, board.GP26, board.GP27, board.GP13, board.GP12)
#cool836rp PCB ver1.01 
